...
- 🔗 **Загрузка по ссылке** — VK Видео / YouTube через yt-dlp (только аудио)
- ✂️ **Фрагмент по таймкодам** «с — по», таймкоды в саммари привязаны к исходнику
- 🧩 **Пресеты саммари** — Полное / Экспресс / Конспект
- 📝 **Расшифровка в результате** по галочке
- 🚦 **Пре-чек качества записи** — предупреждение о тихом звуке и тишине
